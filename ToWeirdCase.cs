...
//Напишите функцию toWeirdCase( weirdcaseв Ruby), которая принимает строку и возвращает ту же строку со всеми символами
//с четным индексом в каждом слове в верхнем регистре и всеми символами с нечетным индексом в каждом слове в нижнем регистре.
...
//Передаваемая строка будет состоять только из букв алфавита и пробелов ( ' '). Пробелы будут присутствовать только в том случае,
//если слов несколько. Слова будут разделены одним пробелом ( ' ').
